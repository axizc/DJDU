...
?>
  ...
  body{
    ...
    font-size:20px;
    background-image: linear-gradient(to bottom left, #94ffca, #94a8ff);
  }
  #button{
    opacity:1;
    padding:5px;
...
ul {
  box-shadow:    box-shadow: 0 15px 12px 0 rgba(0, 0, 0, 0.2), 0 12px 20px 0 rgba(0, 0, 0, 0.19);
  opacity:1;
...
</ul><form method="POST" action="add.php">

DJDU INC <br/><center><br/>
<?php echo $_SESSION['incorrect'];
$_SESSION['incorrect']='';?><br/>
    ...
    <input class="p" placeholder="Email" name="email"type="email" required>
    <br/><button type="submit" id="button"required>Sign up</button>
    <!--<?php 
   # if( $_COOKIE['user']!=''){
