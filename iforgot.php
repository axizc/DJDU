...
</ul><form method="POST" action="forgotten.php">

DJDU INC <br/><center><br/>

Forgot Password<br/><br/><?php echo $_SESSION['correct'];
$_SESSION['correct']='';?>
   <br/> <input class="p" name="user" type="text" placeholder="Username"required><br/><br/>
    <input class="p" name="email" placeholder="Email" type="email"><br/><br/>
    <br/><button type="submit" id="button"required>Submit</button>
    <?php 
    if( $_COOKIE['user']!=''){
